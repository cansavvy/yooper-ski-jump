...
![Craig's Map of Midwest Region Ski Jumps](resources/images/book/image14.gif){fig-align="center" width="90%"}

## Big Miron

When I was still in junior class, we seldom ventured to the bigger hills, but one of the first was Big Miron in Iron Mountain, Michigan. The tournament at Big Miron was one of the few of comparable size to the Iron Bowl, and so it provided a favorable opportunity for young jumpers to get better. It was an all-scaffold hill, with the main inrun and mini-jumps designed into a permanent steel scaffold. Jumping distances barely exceeded 100 feet.

As common on a number of small hills, the meet was broken into two days, with junior (classes 1 - 4) and female competitions being on one day and senior events being on the other.

The results of the competition for that day were determined by jumping distance in one round and subjective style in another round. The jumper would get 4 or 5 rides for the entire meet plus warm up practice beforehand. In that era, judges' scores were not publicly displayed until after the meet had concluded since the scoreboards were either non-existent or positioned in ways not easily viewed by the athletes. Although there were 5 style judges, the high and low scores were tossed and the remaining three judges' scores were added together.

::: {.notice}
Style judging criteria are standardized across the sport. They include quality of the flight (e.g. body position and steadiness) during the three phases of flight (take-off, mid-air, landing), and, of course, a solid Telemark landing with one foot in front of the other and arms and hands extended for positional balance. A Hollywood Telemark was slang for the less skillful, but showy attempt of transitioning to a Telemark position, but only after landing.
:::
...
![The 'New' Wolverine in the Late 1970's](resources/images/book/image15.jpeg){fig-align="center" width="80%"}
...
![1975 – 76 Gogebic Range Ski Jumping Octet at Wolverine](resources/images/book/image16.jpeg){fig-align="center" width="80%"}

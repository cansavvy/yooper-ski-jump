...
As mentioned earlier, in recent decades, Suicide was reclassified from a 70m to a larger (90m) hill size. In fact, the hill size classification for most ski jumps have been revised over recent years.  Two factors have contributed, namely (a) the hill having been physically modified to enable longer jumps, and (b) a revision of the international standard for defining hill size.
...
Regarding the latter (b), the method of classifying a ski jump hill size has evolved to now using the K-Point (or 'K'), instead of the P-point (or 'P').  See figure below. The size of the hill for many decades was defined by the 'P' distance on the hill.  

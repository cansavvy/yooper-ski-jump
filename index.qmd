...
**Dip** – bottom of the landing hill, where the hill transition to the flat outrun is nearly complete, and well beyond where ski jumpers can be safely landing.
...
::: {.dictionary}
**Choppers** – Leather mittens with inner wool liners (Yooperese).
:::
...
K-Point, Hill Size, and Record data are distances in meters  
...
**K-Point** – see Appendix - Ski Jump Classification for detailed explanation.
...
- Secondly, the method of classifying a ski jump hill size has evolved to now using the K-Point (or 'K'), instead of the P-point (or 'P'). Hill size for many decades was defined by the 'P', generally explained as the distance from the take-off to the point on the landing hill where the curvature of the knoll ends and the steepest, constant slope portion of the landing hill begins. The critical point ('K') is a point farther down the hill where the steepest, constant slope section (from 'P' to 'K') ends and the hill begins to flatten out.
